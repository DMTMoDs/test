...
msurl = "raw.githubusercontent.com/DMTMoDs/test/main/LegendaryHub.lua" -- this should be your raw link for it to execute, if its a valid key itll execute this url via loadstring
